...
public class WallpaperLines extends WallpaperService {
	
	public WallpaperLines() {
	...
	class WallpaperEngine extends Engine {
		...
		public WallpaperEngine() {
			...
			jni = new JNI(WallpaperLines.this);
		}
		...
		public void onCreate(SurfaceHolder surfaceHolder) {
			...
			glSurfaceView = new WallpaperGLSurfaceView(WallpaperLines.this);
		...
		class Renderer implements GLSurfaceView.Renderer {
			...
			public void onSurfaceCreated(GL10 gl, EGLConfig config) {
				...
				jni.setString("wallpaper", "lines", engine);
				jni.onResume(engine);
			}
