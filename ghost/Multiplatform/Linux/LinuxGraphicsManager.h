/*
 * LinuxGraphicsManager.h
 *
 *  Created on: 2013.03.26
 *      Author: Martynas Šustavičius
 */

#ifndef LINUXGRAPHICSMANAGER_H_
#define LINUXGRAPHICSMANAGER_H_
...
class LinuxGraphicsManager : public GraphicsManager {
public:
	LinuxGraphicsManager(ServiceLocator* services);
	~LinuxGraphicsManager();
