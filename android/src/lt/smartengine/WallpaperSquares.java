...
public class WallpaperSquares extends WallpaperService {
	
	public WallpaperSquares() {
	...
	class WallpaperEngine extends Engine {
		...
		public WallpaperEngine() {
			...
			jni = new JNI(WallpaperSquares.this);
		}
		...
		public void onCreate(SurfaceHolder surfaceHolder) {
			...
			glSurfaceView = new WallpaperGLSurfaceView(WallpaperSquares.this);
		...
		class Renderer implements GLSurfaceView.Renderer {
			...
			public void onSurfaceCreated(GL10 gl, EGLConfig config) {
				...
				jni.setString("wallpaper", "squares", engine);
				jni.onResume(engine);
			}
