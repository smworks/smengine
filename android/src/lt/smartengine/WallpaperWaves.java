...
public class WallpaperWaves extends WallpaperService {
	
	public WallpaperWaves() {
	...
	class WallpaperEngine extends Engine {
		...
		public WallpaperEngine() {
			...
			jni = new JNI(WallpaperWaves.this);
		}
		...
		public void onCreate(SurfaceHolder surfaceHolder) {
			...
			glSurfaceView = new WallpaperGLSurfaceView(WallpaperWaves.this);
		...
		class Renderer implements GLSurfaceView.Renderer {
			...
			public void onSurfaceCreated(GL10 gl, EGLConfig config) {
				...
				jni.setString("wallpaper", "waves", engine);
				jni.onResume(engine);
			}
