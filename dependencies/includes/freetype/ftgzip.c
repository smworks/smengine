...
#include "gzip/zutil.h"
#include "gzip/inftrees.h"
#include "gzip/infblock.h"
#include "gzip/infcodes.h"
#include "gzip/infutil.h"
#undef  NO_INFLATE_MASK

  /* infutil.c must be included before infcodes.c */
#include "gzip/zutil.c"
#include "gzip/inftrees.c"
#include "gzip/infutil.c"
#include "gzip/infcodes.c"
#include "gzip/infblock.c"
#include "gzip/inflate.c"
#include "gzip/adler32.c"
...
void z_error(char* message) {
    printf("ERROR: problem with freetype: %s\n", message);
}
